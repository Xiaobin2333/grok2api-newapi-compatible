...
func toEgressDomain(row egressNodeModel) egress.Node {
	return egress.Node{
		ID: row.ID, Name: row.Name, Scope: egress.Scope(row.Scope), Enabled: row.Enabled, ForceNoCooldown: row.ForceNoCooldown, ProxyPool: row.ProxyPool,
...
func fromEgressDomain(value egress.Node) egressNodeModel {
	...
	return egressNodeModel{
		ID: value.ID, Name: value.Name, Scope: string(value.Scope), Enabled: value.Enabled, ForceNoCooldown: value.ForceNoCooldown, ProxyPool: value.ProxyPool,
