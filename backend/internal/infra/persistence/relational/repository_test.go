...
func TestFreshSchemaContract(t *testing.T) {
	...
	assertTableColumns(t, database, "request_audits", []string{"media_input_images", "media_output_images", "media_output_seconds", "requested_model", "effective_model", "auto_routed"}, nil)
