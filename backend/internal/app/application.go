...
func New(ctx context.Context, cfg config.Config, logger *slog.Logger) (*Application, error) {
	...
	selector.UpdateFreeAccountMaxConcurrent(cfg.Routing.FreeAccountMaxConcurrent)
	...
	gatewayService.UpdateVideoAccountAttempts(cfg.Routing.VideoPremiumAccountAttempts)
	...
	settingsService := settingsapp.NewService(cfg, settingsUpdatedAt, settingsRevision, runtimeSettingsRepo, notifySettings, func(next config.Config) {
		...
		selector.UpdateFreeAccountMaxConcurrent(next.Routing.FreeAccountMaxConcurrent)
		...
		gatewayService.UpdateVideoAccountAttempts(next.Routing.VideoPremiumAccountAttempts)
