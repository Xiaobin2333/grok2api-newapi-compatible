...
export type SettingsConfigDTO = {
  ...
  providerWeb: {
    ...
    mediaConcurrency: number; allowNSFW: boolean; enableBasicImageEditViaChat: boolean;
  ...
  routing: { stickyTTL: string; cooldownBase: string; cooldownMax: string; capacityWait: string; maxAttempts: number; freeAccountMaxConcurrent: number; videoPremiumAccountAttempts: number; preferFreeBuild: boolean };
...
export type EgressNodeInput = {
  name: string; scope: EgressScope; enabled: boolean; forceNoCooldown: boolean; proxyPool: boolean; proxyURL?: string;
...
const settingsConfigValidator = hasShape({
  ...
  providerWeb: hasShape({
    ...
    clearanceTimeout: isString, clearanceRefresh: isString, mediaConcurrency: isNumber, allowNSFW: isBoolean, enableBasicImageEditViaChat: isBoolean, recoveryBackoffBase: isString, recoveryBackoffMax: isString,
  }),
  ...
  routing: hasShape({ stickyTTL: isString, cooldownBase: isString, cooldownMax: isString, capacityWait: isString, maxAttempts: isNumber, freeAccountMaxConcurrent: isNumber, videoPremiumAccountAttempts: isNumber, preferFreeBuild: isBoolean }),
