...
const endpoints: Record<string, EndpointDefinition> = {
  ...
  "image/generations": {
    ...
    descriptionKey: "docs.endpointImageGeneration", capabilities: ["image", "image_edit"],
    fields: [
      { name: "model", required: true, descriptionKey: "docs.reference.fieldModel" },
      { name: "prompt", required: true, descriptionKey: "docs.reference.fieldPrompt" },
      { name: "image / images / image_urls", descriptionKey: "docs.reference.fieldEditImages" },
      ...
      { name: "partial_images", descriptionKey: "docs.reference.fieldPartialImages" },
      { name: "storage_options", descriptionKey: "docs.reference.fieldStorageOptions" },
    ],
    noteKeys: ["docs.reference.noteImageAutoRoute", "docs.reference.noteImageReferenceOrder", "docs.reference.noteImageOpenAICompatibility", "docs.reference.noteImageCount", "docs.reference.noteImageResponseCompatibility", "docs.reference.noteImageStorage"],
    request: (model) => ({ model, prompt: "Place image 1 in the setting from image 2, using the style of image 3", image: "https://example.com/character.png", images: [{ url: "https://example.com/scene.png" }], image_urls: ["https://example.com/character.png", "https://example.com/style.png"], n: 1, size: "1536x1024", aspect_ratio: "16:9", resolution: "2k", response_format: "url" }),
  ...
  "image/edits": {
    ...
    descriptionKey: "docs.endpointImageEdit", capabilities: ["image", "image_edit"],
    fields: [
      { name: "model", required: true, descriptionKey: "docs.reference.fieldModel" },
      { name: "prompt", required: true, descriptionKey: "docs.reference.fieldPrompt" },
      { name: "image / images / image_urls", required: true, descriptionKey: "docs.reference.fieldEditImages" },
      { name: "n", descriptionKey: "docs.reference.fieldImageCount" },
      { name: "size", descriptionKey: "docs.reference.fieldSize" },
      { name: "aspect_ratio", descriptionKey: "docs.reference.fieldAspectRatio" },
      { name: "resolution", descriptionKey: "docs.reference.fieldResolution" },
    ...
    noteKeys: ["docs.reference.noteEditModelNormalization", "docs.reference.noteEditReferencesRequired", "docs.reference.noteEditJSON", "docs.reference.noteEditSources", "docs.reference.noteImageResponseCompatibility", "docs.reference.noteImageStorage"],
